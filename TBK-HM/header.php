...
session_start();
  ...
  function menuActive() {
    ...
    if($id == 0) {
      ...
      echo "<li><a href='info.php'>お知らせ</a></li>";
      echo "<li><a href='contact.php'>お問い合わせ</a></li>";
    } elseif ($id == 1) {
      ...
      echo "<li><a href='input.php'>登録</a></li>";
      echo "<li><a href='commlist.php'>コメント</a></li>";
      echo "<li class='active'><a href='info.php'>お知らせ</a></li>";
      echo "<li><a href='contact.php'>お問い合わせ</a></li>";
    } elseif ($id == 4) {
      echo "<li><a href='list.php?tg=0'>リスト</a></li>";
      echo "<li><a href='input.php'>登録</a></li>";
      echo "<li><a href='commlist.php'>コメント</a></li>";
      echo "<li><a href='info.php'>お知らせ</a></li>";
      echo "<li class='active'><a href='contact.php'>お問い合わせ</a></li>";
    } else {
      echo "<li><a href='list.php?tg=0'>リスト</a></li>";
      echo "<li><a href='input.php'>登録</a></li>";
      echo "<li><a href='commlist.php'>コメント</a></li>";

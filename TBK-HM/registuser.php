...
<div class="container-fluid">
  ...
  <form class="form-horizontal" style="margin-top: 30px;" action="userinfo_ins.php" method="post">
    ...
    <div class="form-group">
      ...
      <div class="col-md-3">
        <input type="password" class="form-control" id="inp-pass1" name="pass1" value="<?php echo @$_POST['pass1'];?>">
      </div>
    </div>
    <div class="form-group">
      <label for="inp-pass2" class="col-md-3 col-md-offset-2 control-label">パスワード確認</label>
      <div class="col-md-3">
        <input type="password" class="form-control" id="inp-pass2" name="pass2" value="<?php echo @$_POST['pass2'];?>">
      </div>
    </div>
    <div class="form-group">
